...
from zentao_analyzer.agent_client import AgentConfig, AgentResult
from zentao_analyzer.llm_client import call_llm
...
class TestLLMClient(unittest.TestCase):
    def test_call_llm_returns_json_data_and_raw(self):
        ...
        with patch("zentao_analyzer.llm_client.AgentClient") as mock_client:
